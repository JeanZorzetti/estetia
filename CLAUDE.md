# Estetia CRM — Contexto para Claude
...
## Projeto
CRM clínico SaaS para clínicas de estética e dermatologia em Next.js 15 App Router. Deploy: Vercel. DB: PostgreSQL via Prisma (host: `31.97.23.166:5499`).
...
app/
  ...
  api/                # Route handlers
components/
  dashboard/          # Componentes do dashboard clínico
