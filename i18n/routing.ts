...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    '/ferramentas/calculadora-no-show': {
      'pt-BR': '/ferramentas/calculadora-no-show',
      en: '/tools/no-show-calculator',
    },
    '/ferramentas/calculadora-ltv': {
      'pt-BR': '/ferramentas/calculadora-ltv',
      en: '/tools/ltv-calculator',
    },
    '/ferramentas/calculadora-precificacao': {
      'pt-BR': '/ferramentas/calculadora-precificacao',
      en: '/tools/pricing-calculator',
    },
    '/ferramentas/avaliacao-maturidade-digital': {
      'pt-BR': '/ferramentas/avaliacao-maturidade-digital',
      en: '/tools/digital-maturity-assessment',
    },
