...
export const helpArticles: HelpArticle[] = [
  // ===== PRIMEIROS PASSOS =====
  {
    ...
    description: "Guia completo para criar e gerenciar seu primeiro deal no Estetia CRM",
    ...
    content: {
      sections: [
        {
          title: "Introdução",
          content: "Criar seu primeiro negócio no Estetia CRM é simples e intuitivo. Um 'deal' (ou negócio) representa uma oportunidade de venda que você está trabalhando ativamente. Cada deal contém informações como valor, contato responsável, e em qual etapa do processo de venda ele está.",
        },
        {
    ...
    descriptionEn: "Complete guide to creating and managing your first deal in Estetia CRM",
    contentEn: {
      sections: [
        {
          title: "Introduction",
          content: "Creating your first deal in Estetia CRM is simple and intuitive. A 'deal' represents a sales opportunity you are actively working on. Each deal holds information like value, the associated contact, and which stage of your sales process it is in.",
        },
        {
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          content: "Quando você cria sua conta no Estetia CRM, já vem com um pipeline padrão com 5 etapas:",
          steps: [
    ...
    contentEn: {
      sections: [
        ...
        },
        {
          ...
          content: "When you create your Estetia CRM account, it comes pre-loaded with a default 5-stage pipeline:",
          steps: [
...

  {
    ...
    description: "Aprenda a criar e organizar seus contatos no Estetia CRM",
    titleEn: "How to Add and Manage Contacts",
    descriptionEn: "Learn how to create and organize your contacts in Estetia CRM",
    lastUpdated: "2024-01-23",
    readTime: "3 min",
    content: {
      sections: [
        {
          ...
          content: "Todo deal no Estetia CRM precisa estar associado a um contato. Os contatos representam as pessoas ou empresas com quem você está fazendo negócio. Manter uma base de contatos organizada facilita o acompanhamento, histórico de interações e automações futuras.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "Every deal in Estetia CRM needs to be linked to a contact. Contacts represent the people or companies you are doing business with. Keeping a well-organized contact base makes follow-up, interaction history, and future automations much easier.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "O Estetia CRM tem integração nativa com WhatsApp Web. Quando você clica no botão verde (ícone do WhatsApp) em um card de deal, o WhatsApp Web abre automaticamente com uma mensagem pré-formatada para aquele contato. É rápido, simples e não requer configuração complexa.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "Estetia CRM has native integration with WhatsApp Web. When you click the green button (WhatsApp icon) on a deal card, WhatsApp Web opens automatically with a pre-formatted message for that contact. It is fast, simple, and requires no complex setup.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "A integração com Google Calendar permite que você agende follow-ups e reuniões diretamente no Estetia CRM e eles apareçam automaticamente no seu calendário. Além disso, você pode ver seus próximos compromissos sem sair do CRM.",
        },
        {
          ...
          steps: [
            ...
            "Autorize o Estetia CRM a acessar seu calendário (permissão somente leitura)",
            "Aguarde a sincronização - pode levar alguns segundos",
            "Pronto! Agora você pode agendar eventos direto do CRM",
          ],
          warning: "O Estetia CRM nunca modifica ou deleta eventos existentes. A integração é segura e você pode desconectar a qualquer momento.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "The Google Calendar integration lets you schedule follow-ups and meetings directly in Estetia CRM, and they appear automatically in your calendar. You can also see upcoming appointments without leaving the CRM.",
        },
        {
          ...
          steps: [
            ...
            "Authorize Estetia CRM to access your calendar (read-only permission)",
            "Wait for the sync — it may take a few seconds",
            "Done! You can now schedule events directly from the CRM",
          ],
          warning: "Estetia CRM never modifies or deletes existing events. The integration is safe and you can disconnect at any time.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "O Estetia CRM tem 3 níveis de permissão para usuários:",
          steps: [
      ...
      sections: [
        {
          ...
          content: "Estetia CRM has 3 user permission levels:",
          steps: [
      ...
      sections: [
        {
          ...
          content: "Se você já tem uma base de contatos em planilha (Excel, Google Sheets) ou está migrando de outro CRM, a importação via CSV é a forma mais rápida de trazer todos os dados para o Estetia CRM de uma vez.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "If you already have a contact base in a spreadsheet (Excel, Google Sheets) or are migrating from another CRM, CSV import is the fastest way to bring all your data into Estetia CRM at once.",
        },
        {
    ...
    content: {
      sections: [
        ...
        },
        {
          ...
          content: "A busca do Estetia CRM procura em múltiplos campos: título do deal, nome do contato, empresa e observações. Digite qualquer termo relacionado e encontre rapidamente o que precisa.",
        },
      ],
    },
    contentEn: {
      sections: [
        ...
        {
          title: "Smart search",
          content: "Estetia CRM's search looks across multiple fields: deal title, contact name, company, and notes. Type any related term to quickly find what you need.",
        },
      ],
    },
  },
      ...
      sections: [
        {
          ...
          content: "O Estetia CRM envia notificações para mantê-lo informado sobre eventos importantes. Você tem controle total sobre quais notificações receber e por qual canal (email, in-app, push).",
        },
        {
      ...
      sections: [
        {
          ...
          content: "Estetia CRM sends notifications to keep you informed about important events. You have full control over which notifications to receive and through which channel (email, in-app, push).",
        },
        {
  ...
  {
    title: "Usando a API do Estetia CRM",
    slug: "usando-api",
    category: "Integrações",
    categorySlug: "integracoes",
    description: "Como gerar chaves de API e integrar o Estetia com sistemas externos",
    titleEn: "Using the Estetia CRM API",
    descriptionEn: "How to generate API keys and integrate Estetia with external systems",
    lastUpdated: "2024-01-23",
    readTime: "5 min",
    content: {
      sections: [
        {
          title: "O que é a API?",
          content: "A API (Application Programming Interface) do Estetia CRM permite que você integre o CRM com outros sistemas, automatize tarefas e crie aplicações customizadas. É uma forma de fazer o Estetia conversar com suas outras ferramentas programaticamente.",
        },
        {
        ...
        },
        {
          ...
          content: "A API REST do Estetia oferece endpoints para:",
          steps: [
      ...
      sections: [
        {
          ...
          content: "The Estetia CRM API (Application Programming Interface) lets you integrate the CRM with other systems, automate tasks, and build custom applications. It is the way to make Estetia communicate with your other tools programmatically.",
        },
        {
        ...
        },
        {
          ...
          content: "The Estetia REST API provides endpoints for:",
          steps: [
...

  {
    ...
    category: "Integrações",
    categorySlug: "integracoes",
    description: "Como conectar o Estetia CRM com N8N para criar workflows avançados",
    titleEn: "Integrating with N8N (Low-Code Automation)",
    descriptionEn: "How to connect Estetia CRM with N8N to create advanced workflows",
    lastUpdated: "2024-01-23",
    readTime: "6 min",
    content: {
      sections: [
        {
          title: "O que é N8N?",
          content: "N8N é uma ferramenta de automação low-code, similar ao Zapier mas open-source e auto-hospedável. Com ela, você pode criar workflows complexos conectando o Estetia CRM a centenas de outras ferramentas sem escrever código.",
        },
        {
          title: "Configurando a integração",
          content: "Para conectar o Estetia ao N8N:",
          steps: [
            "Crie uma conta no N8N (cloud ou self-hosted)",
            "No Estetia, vá em Configurações > Integrações > N8N",
            "Gere uma API key (ou use uma existente)",
            "No N8N, crie um novo workflow",
            "Adicione um node 'HTTP Request' ou 'Webhook'",
            "Configure a URL base: https://estetiacrm.com.br/api",
        ...
        },
        {
          ...
          content: "O Estetia pode disparar webhooks para o N8N quando eventos acontecem:",
          steps: [
    ...
    contentEn: {
      sections: [
        {
          title: "What is N8N?",
          content: "N8N is a low-code automation tool, similar to Zapier but open-source and self-hostable. With it, you can build complex workflows connecting Estetia CRM to hundreds of other tools without writing code.",
        },
        {
          title: "Setting up the integration",
          content: "To connect Estetia to N8N:",
          steps: [
            "Create an N8N account (cloud or self-hosted)",
            "In Estetia, go to Settings > Integrations > N8N",
            "Generate an API key (or use an existing one)",
            "In N8N, create a new workflow",
            "Add an 'HTTP Request' or 'Webhook' node",
            "Set the base URL: https://estetiacrm.com.br/api",
        ...
        {
          title: "Webhook triggers",
          content: "Estetia can trigger webhooks to N8N when events occur:",
          steps: [
      ...
      sections: [
        {
          ...
          content: "Todo negócio tem um processo de venda único. As etapas padrão do Estetia são um bom ponto de partida, mas você pode (e deve!) ajustá-las para refletir seu fluxo real. Isso torna o CRM mais intuitivo e os dados mais precisos.",
        },
        {
      ...
      sections: [
        {
          ...
          content: "Every business has a unique sales process. Estetia's default stages are a good starting point, but you can (and should!) adjust them to reflect your real flow. This makes the CRM more intuitive and your data more accurate.",
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          tips: [
            ...
            "O Estetia não armazena dados do cartão - tudo via Stripe (PCI compliant)",
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          tips: [
            ...
            "Estetia does not store card data — everything is handled via Stripe (PCI compliant)",
          ],
        },
        {
          title: "Changing plan",
...

  {
    ...
    category: "Primeiros Passos",
    categorySlug: "primeiros-passos",
    description: "Dicas e estratégias para maximizar resultados com o Estetia CRM",
    titleEn: "Sales Management Best Practices",
    descriptionEn: "Tips and strategies to maximize results with Estetia CRM",
    lastUpdated: "2024-01-23",
    readTime: "6 min",
    content: {
      sections: [
        {
          title: "Introdução",
          content: "Um CRM é apenas uma ferramenta. O que realmente gera resultados é como você usa. Aqui estão as melhores práticas compiladas de centenas de equipes de vendas bem-sucedidas usando o Estetia CRM.",
        },
        {
        ...
        },
        {
          ...
          content: "Não crie silos. Integre o Estetia com email, calendário, WhatsApp, automações (N8N). Quanto mais conectado, menos trabalho manual e mais tempo vendendo.",
        },
        {
    ...
    contentEn: {
      sections: [
        {
          title: "Introduction",
          content: "A CRM is just a tool. What really generates results is how you use it. Here are the best practices compiled from hundreds of successful sales teams using Estetia CRM.",
        },
        {
        ...
        },
        {
          ...
          content: "Don't create silos. Integrate Estetia with email, calendar, WhatsApp, and automations (N8N). The more connected, the less manual work and more time selling.",
        },
        {
...

  {
    ...
    category: "Primeiros Passos",
    categorySlug: "primeiros-passos",
    description: "Soluções para os problemas mais comuns no Estetia CRM",
    titleEn: "Troubleshooting: Common Problems and Solutions",
    descriptionEn: "Solutions for the most common issues in Estetia CRM",
    lastUpdated: "2024-01-23",
    readTime: "4 min",
    content: {
      sections: [
