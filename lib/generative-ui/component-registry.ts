...
export const SALES_UI_COMPONENTS: ComponentRegistry = {
  ROICalculator: {
    name: 'ROICalculator',
    description: 'Calculadora interativa de ROI para demonstrar valor do Estetia CRM',
    when_to_use: [
  ...
  DealFormGenerator: {
    ...
    example: {
      ...
      invocation: {
        prefill: {
          title: 'Implementação Estetia CRM - Clínica Excellence',
          value: 12000,
  ...
  ScriptPreview: {
    ...
    example: {
      ...
      invocation: {
        ...
        content: 'Olá [Nome], aqui é da Estetia CRM...',
        metadata: {
  ...
  QualificationDashboard: {
    ...
    when_to_use: [
      ...
      'usuário questiona fit do produto ("Estetia é pra mim?")',
  ...
  CompetitorMatrix: {
    ...
    description: 'Matriz comparativa Estetia vs Concorrentes (Pipedrive, HubSpot, etc.)',
    when_to_use: [
  ...
  OnboardingTimeline: {
    ...
    description: 'Timeline visual de implementação do Estetia CRM',
    when_to_use: [
  ...
  EmailPreview: {
    ...
    example: {
      ...
      invocation: {
        template: {
          subject: 'Bem-vindo ao Estetia CRM, {{contact_name}}!',
