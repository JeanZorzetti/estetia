...
describe('detectIntent', () => {
  it('detects pricing inquiry', () => {
    const intent = detectIntent('Quanto custa o Estetia?')
  ...
  it('detects ROI calculation intent', () => {
    ...
    const intent = detectIntent('Calcular o ROI do Estetia')
  ...
  it('detects competitor comparison intent', () => {
    const intent = detectIntent('Qual a diferença entre Estetia e Pipedrive?')
  ...
  it('detects deal creation intent', () => {
    const intent = detectIntent('Quero contratar o Estetia')
  ...
  it('detects qualification check intent', () => {
    const intent = detectIntent('O Estetia é pra mim?')
