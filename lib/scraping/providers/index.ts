 ...
 * 
 * Ordem de prioridade:
 * 1. Estetia Scraper (nosso servidor self-hosted - GRATUITO)
...
import { estetiaScraperProvider } from './estetia-scraper-provider'
...
const providers: ScrapingProvider[] = [
  estetiaScraperProvider,    // Prioridade 1: Nosso servidor (GRATUITO)
...
export * from './base'
export { estetiaScraperProvider, scrapingBeeProvider, googlePlacesProvider, hybridCrawlerProvider, cnpjApiProvider }
