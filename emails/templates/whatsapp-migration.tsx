...
export function WhatsAppMigrationEmail({
  userName,
  organizationName,
  upgradeUrl = 'https://estetiacrm.com.br/dashboard/billing/plans',
  locale = 'pt-BR',
  ...
  return (
    <BaseLayout preview={s.preview} locale={locale}>
      ...
      <Section style={styles.ctaSection}>
        <Button href="https://estetiacrm.com.br/dashboard/settings/integrations/whatsapp-official" style={styles.button}>
          {s.cta}
        </Button>
      </Section>

      <Text style={styles.footnote}>
        {s.footnote.includes('estetiacrm.com.br') ? (
          <>
            {s.footnote.split('estetiacrm.com.br')[0]}
            <Link href="https://estetiacrm.com.br" style={styles.inlineLink}>estetiacrm.com.br</Link>
            {s.footnote.split('estetiacrm.com.br')[1]}
          </>
        ) : s.footnote}
      </Text>
