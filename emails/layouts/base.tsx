      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.header}>
            <Text style={styles.logo}>Estetia CRM</Text>
          </Section>
          ...
          <Section style={styles.footer}>
            ...
            <Text style={styles.footerText}>
              <Link href="https://estetiacrm.com.br" style={styles.link}>
                estetiacrm.com.br
              </Link>
              {' • '}
              <Link href="https://estetiacrm.com.br/privacy" style={styles.link}>
                {footer.privacy}
              </Link>
              {' • '}
              <Link href="https://estetiacrm.com.br/terms" style={styles.link}>
                {footer.terms}
              </Link>
            </Text>
          </Section>
