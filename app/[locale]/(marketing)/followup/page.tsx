  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Follow-up",
        "item": "https://estetiacrm.com.br/followup"
      }
    ]
  }
      ...
      <div className="container mx-auto max-w-6xl py-12 px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Pare de perder vendas por esquecimento. O Estetia CRM te lembra automaticamente quando fazer follow-up com cada lead, no momento certo.
          </p>
