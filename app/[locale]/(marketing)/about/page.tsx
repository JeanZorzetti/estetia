...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "itemListElement": [
      { "@type": "ListItem", "position": 1, "name": t('schema.breadcrumbHome'), "item": "https://estetiacrm.com.br" },
      { "@type": "ListItem", "position": 2, "name": t('schema.breadcrumbAbout'), "item": "https://estetiacrm.com.br/about" }
    ]
  }
