  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://estetiacrm.com.br/vendas-automaticas"
      }
    ]
  }
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="border-2 border-blue-500 dark:border-blue-600 bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/20 dark:to-zinc-900 shadow-xl shadow-blue-500/10 relative">
                ...
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    <CardTitle className="text-2xl">Estetia Self-Service</CardTitle>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-zinc-600 dark:text-zinc-400">
                    <strong className="text-zinc-900 dark:text-white">Não.</strong> O Estetia é tão intuitivo que você aprende sozinho.
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-zinc-600 dark:text-zinc-400">
                    <strong className="text-zinc-900 dark:text-white">Sim!</strong> O Estetia é um Progressive Web App (PWA).
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-blue-100">
              Junte-se a 50+ empresas que organizaram suas vendas com o Estetia.{' '}
