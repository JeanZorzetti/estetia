...
const benefits = [
  ...
  },
  {
    ...
    description: 'Suas sugestões e feedback moldam as próximas funcionalidades do Estetia CRM.',
    icon: Trophy,
  },
  {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Comunidade",
        "item": "https://estetiacrm.com.br/community"
      }
    ]
  }
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border rounded-lg overflow-hidden bg-card hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    Descubra como empresas estão usando o Estetia CRM para fechar mais negócios.
                  </p>
                  <Button asChild variant="link" className="p-0">
