...
export default function ContactPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Contact", item: "https://estetiacrm.com.br/contact" },
    ],
  };
  ...
  const contactPageSchema = {
    "@context": "https://schema.org",
    "@type": "ContactPage",
    name: "Contact - Estetia CRM",
    description: "Get in touch with the Estetia CRM team",
    url: "https://estetiacrm.com.br/contact",
    mainEntity: {
      "@type": "Organization",
      name: "Estetia CRM",
