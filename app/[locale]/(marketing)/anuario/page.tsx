...
const datasetSchema = {
  ...
  description: 'Dados sobre ciclo de venda, conversão e produtividade de +127 empresas B2B brasileiras que utilizam o Estetia CRM',
  url: 'https://estetiacrm.com.br/anuario',
  creator: {
    '@type': 'Organization',
    name: 'Estetia CRM / ROI Labs',
  ...
  measurementTechnique: 'Dados anonimizados de usuários Estetia CRM',
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Início',
      item: 'https://estetiacrm.com.br',
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Anuário 2026',
      item: 'https://estetiacrm.com.br/anuario',
    },
  ],
}
    ...
    <>
      ...
      <main className="min-h-screen bg-zinc-950 text-white">
        ...
        <section className="relative overflow-hidden border-b border-zinc-800">
          ...
          <div className="relative mx-auto max-w-5xl px-4 py-20 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-zinc-300 mb-4">
              Dados proprietários de <strong className="text-white">+127 empresas</strong> que usam o Estetia CRM — ciclo médio de venda, taxa de conversão, impacto da IA e benchmarks por setor no Brasil.
            </p>
          ...
          <div className="mx-auto max-w-5xl px-4 py-10">
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              <div className="rounded-xl border border-zinc-700/50 bg-zinc-800/50 p-5 text-center">
                ...
                <p className="mt-1 text-sm text-zinc-400">Ciclo de venda<br />com Estetia CRM</p>
              </div>
              <div className="rounded-xl border border-zinc-700/50 bg-zinc-800/50 p-5 text-center">
        ...
        <div className="mx-auto max-w-5xl px-4 py-12 space-y-16">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-2">Benchmarks Gerais: Mercado vs Estetia CRM</h2>
            <p className="text-zinc-400 mb-6">
              Comparativo entre a média do mercado B2B brasileiro e os resultados medidos em empresas que utilizam o Estetia CRM. Dados coletados de janeiro de 2025 a março de 2026.
            </p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-zinc-800 text-zinc-300">
                    ...
                    <th className="px-5 py-3.5 text-center font-semibold border-b border-zinc-700">Com Estetia CRM</th>
            ...
            <p className="mt-3 text-xs text-zinc-500">
              Fonte: Estetia CRM / ROI Labs — análise de +127 empresas B2B brasileiras. Período: jan/2025–mar/2026. Dados anonimizados.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-xs text-zinc-500">
              Fonte: Estetia CRM — análise segmentada por setor. Médias calculadas sobre deals fechados no período jan/2025–mar/2026.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400 mb-6">
              Resultados medidos em empresas que ativaram os recursos de inteligência artificial do Estetia CRM — qualificação BANT, follow-up automatizado, geração de propostas e score de oportunidade.
            </p>
            <div className="overflow-x-auto rounded-xl border border-zinc-700/50">
              <table className="w-full text-sm">
                <thead>
            ...
            <p className="mt-3 text-xs text-zinc-500">
              Fonte: Estetia CRM — comparativo antes/depois da ativação dos recursos de IA. Amostra: empresas com mínimo de 90 dias de uso de cada recurso.
            </p>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-zinc-700/50 bg-zinc-800/50 p-6">
                ...
                <p className="text-zinc-300 leading-relaxed">
                  A taxa média de conversão de leads B2B no Brasil em 2026 é de <strong className="text-white">8%</strong> (lead → cliente) segundo os dados do Anuário Estetia CRM 2026, coletados de +127 empresas. Empresas que utilizam qualificação por IA (BANT/MEDDIC) e automação de follow-up atingem taxas de <strong className="text-white">14% ou mais</strong> — representando uma melhoria de 75% sobre a média do mercado. O setor com maior taxa de conversão é Distribuição/Atacado (35%), enquanto Energia Solar apresenta o menor índice (12%) compensado pelo alto deal size médio de R$ 28.000.
                </p>
              </div>
          ...
          <section className="rounded-xl border border-zinc-700/50 bg-zinc-800/30 p-6">
            ...
            <div className="text-sm text-zinc-400 space-y-2">
              <p><strong className="text-zinc-200">Amostra:</strong> +127 empresas B2B brasileiras ativas no Estetia CRM com mínimo de 6 meses de uso registrado.</p>
              <p><strong className="text-zinc-200">Período:</strong> Janeiro de 2025 a março de 2026.</p>
              <p><strong className="text-zinc-200">Coleta:</strong> Dados anonimizados e agregados automaticamente pela plataforma Estetia CRM, mediante consentimento dos usuários.</p>
              ...
              <p><strong className="text-zinc-200">Licença:</strong> Os dados deste anuário estão disponíveis sob licença <a href="https://creativecommons.org/licenses/by/4.0/" className="text-indigo-400 hover:underline" target="_blank" rel="noopener noreferrer">Creative Commons BY 4.0</a>. Citação obrigatória: "Anuário do Vendedor B2B Brasileiro 2026 — Estetia CRM / ROI Labs".</p>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/60 to-violet-950/60 p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-3">
              Melhore seus resultados com o Estetia CRM
            </h2>
