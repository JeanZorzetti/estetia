...
const categories = [
  {
    ...
    description: "Setup inicial e conceitos básicos do Estetia CRM",
...
const articlesByCategory = {
  "primeiros-passos": [
    ...
    { title: "Atalhos de teclado do Estetia CRM", slug: "atalhos-teclado" },
  ...
  "integracoes": [
    ...
    { title: "Usando a API do Estetia CRM", slug: "usando-api" },
        ...
        <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-primary/5 to-transparent">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Encontre respostas, tutoriais e guias para aproveitar o máximo do Estetia CRM.
            </p>
            ...
            <div className="bg-card border border-border rounded-2xl p-8 md:p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center mt-8">
                ...
                <Button size="lg" variant="outline" asChild>
                  <a href="https://wa.me/5562998015884?text=Olá! Preciso de ajuda com o Estetia CRM." target="_blank" rel="noopener noreferrer">
                    Urgente? WhatsApp
                  </a>
                </Button>
              </div>
