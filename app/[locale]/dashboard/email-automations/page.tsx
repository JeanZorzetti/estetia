...
export const metadata = {
  title: 'Automações de Email | Estetia CRM',
...
export default async function EmailAutomationsPage() {
  ...
  const defaultTemplates = {
    WELCOME_EMAIL: {
      subject: 'Bem-vindo ao Estetia CRM, {{userName}}!',
      body: `Olá {{userName}},

Bem-vindo ao Estetia CRM! Estamos muito felizes em ter você e a {{organizationName}} conosco.
