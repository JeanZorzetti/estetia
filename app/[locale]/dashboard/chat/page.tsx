            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-amber-800 text-sm leading-relaxed">
                  A Meta está banindo números que utilizam APIs não oficiais do WhatsApp (como Evolution API, Baileys e similares). Para proteger seu negócio, o Estetia CRM migrou para a <strong>API Oficial do WhatsApp Business (Meta Cloud API)</strong> — a única integração permitida pelos Termos de Uso da Meta.
                </p>
                <a
