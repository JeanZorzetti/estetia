...
export async function GET() {
  try {
    ...
    const filePath = join(process.cwd(), 'public', 'downloads', 'Planilha-Controle-Comissao-Corretor-2026-Estetia-CRM.xlsx');
    ...
    return new NextResponse(fileBuffer, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="Planilha-Controle-Comissao-Corretor-2026-Estetia-CRM.xlsx"',
