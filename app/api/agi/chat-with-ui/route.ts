/**
 * Estetia IA - Chat with Generative UI API Route
 *
...
/**
 * Base system prompt for Estetia IA
 */
const BASE_SYSTEM_PROMPT = `Você é Estetia IA, uma assistente clínica especializada em gestão de clínicas de estética e dermatologia.
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // 1b. Module gate — requires any IA module
