...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); padding: 30px; border-radius: 10px 10px 0 0;">
    ...
    <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0;">Estetia CRM - Formulario de Contato</p>
  </div>
  ...
  <div style="background: #374151; padding: 20px; border-radius: 0 0 10px 10px; text-align: center;">
    <p style="color: rgba(255,255,255,0.7); margin: 0; font-size: 12px;">
      Esta mensagem foi enviada atraves do formulario de contato do Estetia CRM
    </p>
...
`;
    ...
    const emailResult = await sendHtmlEmail({
      ...
      subject: `[Estetia CRM] ${subjectLabels[subject]} - ${name}`,
      html: htmlContent,
    });
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <ul style="margin: 10px 0 20px 0; padding-left: 20px;">
      <li>Consultar nossa <a href="https://estetiacrm.com.br/help" style="color: #7c3aed;">Central de Ajuda</a></li>
      <li>Conhecer nossos <a href="https://estetiacrm.com.br/pricing" style="color: #7c3aed;">Planos e Precos</a></li>
      <li>Explorar as <a href="https://estetiacrm.com.br/features" style="color: #7c3aed;">Funcionalidades</a> do Estetia CRM</li>
    </ul>

    <p style="margin: 0;">Atenciosamente,<br><strong>Equipe Estetia CRM</strong></p>
  </div>

  <div style="background: #374151; padding: 20px; border-radius: 0 0 10px 10px; text-align: center;">
    <p style="color: rgba(255,255,255,0.7); margin: 0; font-size: 12px;">
      Estetia CRM - Parte do Grupo ROI Labs
    </p>
    <p style="color: rgba(255,255,255,0.5); margin: 10px 0 0 0; font-size: 11px;">
      <a href="https://estetiacrm.com.br" style="color: rgba(255,255,255,0.5);">estetiacrm.com.br</a>
    </p>
  </div>
</body>
</html>
`;
    ...
    sendHtmlEmail({
      to: email,
      subject: "Recebemos sua mensagem - Estetia CRM",
