...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const seoSystemPrompt = `Você é o Head de SEO da Estetia CRM. Sua missão é analisar dados brutos do Google Search Console e dar conselhos táticos para aumentar tráfego orgânico sem gastar em ads.
