    ...
    return NextResponse.json(
      {
        ...
        reason: 'A Meta está banindo contas que utilizam APIs não oficiais do WhatsApp. Para proteger seu número, o Estetia CRM migrou para a API Oficial do WhatsApp Business (Meta Cloud API), disponível apenas no plano Business.',
