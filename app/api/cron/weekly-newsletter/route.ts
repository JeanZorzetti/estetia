...
const SALES_TIPS = [
  ...
  },
  {
    ...
    body: 'Estudos mostram que o segundo contato aumenta a taxa de resposta em 21%. Use os alertas automáticos do Estetiapara nunca deixar um negócio sem resposta por mais de 3 dias.',
  },
  {
    title: 'Segmente por valor para priorizar energia',
    body: 'Filtre seus deals pelo valor potencial e dedique 60% do seu tempo nos 20% mais valiosos. Use a visão Kanban do Estetiapara identificar rapidamente onde está o maior impacto.',
  },
]
    ...
    for (const org of orgs) {
      ...
      try {
        ...
        const subject = locale === 'en'
          ? `📊 Weekly Summary (${weekLabel}) – Estetia CRM`
          : `📊 Resumo da semana (${weekLabel}) – Estetia CRM`
        await sendEmail({
          to: owner.email,
          subject,
