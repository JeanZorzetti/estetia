...
Responda sempre em português. Use markdown com tabelas e listas quando útil. Seja específico.`
  ...
  const analyzePrompt = `Analise este knowledge graph do blog do Estetia CRM (SaaS de vendas B2B) e produza uma síntese executiva com:
...
${ctx}`
  ...
  const suggestPrompt = `Com base neste knowledge graph do blog do Estetia CRM (SaaS de vendas B2B), sugira artigos a criar.
