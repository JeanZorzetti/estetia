        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[440px] p-0 max-h-[90vh] flex flex-col border-0 shadow-2xl bg-zinc-950 text-white ring-1 ring-white/10 gap-0">
                ...
                <div className="relative pt-6 pb-5 px-5 bg-gradient-to-br from-indigo-950 via-zinc-900 to-zinc-950 overflow-hidden text-center shrink-0">
                    {/* Background Effects */}
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1a3560] via-purple-500 to-[#a8853f]" />
                    <div className="absolute top-[-50px] right-[-50px] w-32 h-32 bg-[#489fb5]/15 blur-[60px] rounded-full pointing-events-none" />
                    <div className="absolute bottom-[-30px] left-[-30px] w-40 h-40 bg-[#1a3560]/10 blur-[50px] rounded-full pointing-events-none" />

                    <div className="relative z-10 flex flex-col items-center">
                        <div className="w-12 h-12 bg-gradient-to-br from-[#1a3560]/20 to-[#1a3560]/20 rounded-2xl flex items-center justify-center mb-3 ring-1 ring-white/10 shadow-[0_0_30px_-5px_rgba(99,102,241,0.3)] backdrop-blur-sm animate-pulse">
                            <Crown className="w-6 h-6 text-[#489fb5]" />
                        </div>
                ...
                <div className="px-5 py-4 bg-zinc-950 flex-1 overflow-y-auto min-h-0">
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-3 p-2.5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors group">
                            <div className="p-1.5 rounded-lg bg-[#489fb5]/8 text-purple-400 group-hover:scale-110 transition-transform shrink-0">
