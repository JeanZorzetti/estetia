...
export function FunnelTemplateDownload() {
  ...
  const generatePDF = async () => {
    ...
    // Cores da paleta Estetia (apenas tons de azul)
    const colors = {
      primary: [37, 99, 235] as [number, number, number],       // #2563eb - Azul principal Estetia
    ...
    const addFooter = (pageNum: number) => {
      ...
      // Texto esquerda
      doc.text('Estetia CRM', 10, footerY)

      // Texto centro
      const centerText = 'https://estetiacrm.com.br/register'
    ...
    doc.setFontSize(9)
    doc.setFont('helvetica', 'normal')
    addCenteredText('Estetia CRM', 35, 9)
    ...
    const lines = doc.splitTextToSize(
      'Revise este checklist semanalmente nas primeiras 4 semanas e mensalmente depois. Cada negocio e unico - adapte conforme necessario! Use o Estetia CRM para automatizar todo esse processo e aumentar suas taxas de conversao.',
      pageWidth - 30
    )
