...
const results = [
  {
    ...
    advice:
      'Seu processo ainda depende muito de memória e controle manual. Você está perdendo entre 30% e 50% das oportunidades por falta de automação. O Estetia CRM pode mudar isso gratuitamente.',
  },
  {
    range: [2, 3],
      ...
      {!submitted ? (
        ...
        <div className={`border-l-4 p-5 rounded-r-xl ${result?.borderColor} ${result?.bg}`}>
          ...
          <div className="flex gap-3 flex-wrap items-center">
            ...
            >
              Começar com Estetia CRM gratuitamente →
            </a>
            <button
              onClick={() => {
                setAnswers({})
