                  ...
                  <div className="flex flex-wrap gap-3">
                    {task.deal && (
                      <a
                        ...
                        className="group flex items-center gap-2 rounded-xl bg-[#1a3560]/10 hover:bg-[#1a3560]/20 px-4 py-2 transition-all"
                      >
                        <div className="h-2 w-2 rounded-full bg-[#1a3560] group-hover:scale-125 transition-transform" />
                        <span className="text-sm font-semibold text-indigo-700 dark:text-[#489fb5]">Deal: {task.deal.title}</span>
                      </a>
                    )}
                    {task.contact && (
                      <a
