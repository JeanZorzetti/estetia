...
export function CalculadoraROIWithLeadCapture({
  ...
  const resultados = useMemo(() => {
    ...
    const custoEstetia = 67
    const roiMensal = perdaMensal / custoEstetia
    const roiPrimeirasSemanas = (perdaMensal / 4) / custoEstetia
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-[#1a3560] tabular-nums">
                  {taxaConversao}%
                </span>
              </div>
              <Slider
            ...
            <div className="space-y-4 pt-6 border-t-2 border-dashed border-zinc-200 dark:border-zinc-800">
              ...
              {hasSubmittedEmail && (
                <>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3 p-4 rounded-xl bg-[#1a3560]/5 border border-[#0a1f3d]/20">
                    <div className="text-center sm:text-left">
                      <p className="text-xs text-muted-foreground mb-1">Investimento Estetia</p>
                      <p className="text-xl font-bold text-[#0a1f3d] dark:text-[#489fb5]">R$ 67/mês</p>
                    </div>
                    <div className="text-center sm:text-left">
                      <p className="text-xs text-muted-foreground mb-1">ROI Mensal</p>
                      <p className="text-xl font-bold text-[#0a1f3d] dark:text-[#489fb5]">
                  ...
                  <div className="pt-6">
                    <Button
                      ...
                      size="lg"
                      className="w-full h-14 text-lg font-bold bg-gradient-to-r from-[#0a1f3d] to-[#0a1f3d] hover:from-indigo-700 hover:to-indigo-800 shadow-xl shadow-indigo-500/30"
                    >
                      {ctaText}
