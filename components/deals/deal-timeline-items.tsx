...
// Note and activity timeline items for the deal dialog (extracted from edit-deal-dialog.tsx)

import { Button } from '@/components/ui/button'
import {
    ArrowRight, ArrowLeftRight, DollarSign, MessageSquare,
...
export function NoteItem({ note, onDelete }: { note: any, onDelete: () => void }) {
    return (
