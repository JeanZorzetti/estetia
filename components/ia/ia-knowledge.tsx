...
const ALL_AGENTS: AgentOption[] = [
  ...
  { id: 'followup-coordinator', name: 'FollowUp', gradient: 'from-violet-500 to-[#1a3560]', icon: MessageSquare },
  ...
  { id: 'property-matcher', name: 'PropertyMatch', gradient: 'from-[#1a3560] to-blue-600', icon: Home },
...
function AgentChipStyled({ agent, selected, onClick }: { agent: AgentOption; selected: boolean; onClick: () => void }) {
  ...
  const gradientColors: Record<string, string> = {
    ...
    'from-violet-500 to-[#1a3560]': 'linear-gradient(135deg, #8b5cf6, #a855f7)',
    ...
    'from-[#1a3560] to-blue-600': 'linear-gradient(135deg, #6366f1, #2563eb)',
