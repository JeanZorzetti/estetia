...
const CORE_AGENTS: AgentOption[] = [
  ...
  { id: 'followup-coordinator', name: 'FollowUpCoordinator', description: 'Follow-ups personalizados em deals parados.', icon: MessageSquare, gradient: 'from-violet-500 to-[#1a3560]' },
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-zinc-100 mb-1">Ativar Estetia IA</h1>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-sm text-zinc-500 mb-6">Estetia IA está configurado e pronto para operar.</p>
