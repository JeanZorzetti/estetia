...
export function TemplateEditor({
  ...
  const getPreviewContent = (content: string) => {
    const sampleData = {
      ...
      '{{dealUrl}}': 'https://estetiacrm.com.br/dashboard?deal=123',
      '{{assigneeName}}': 'João Silva',
      '{{oldStage}}': 'Qualificação',
      '{{newStage}}': 'Negociação',
      '{{currentDeals}}': '8',
      '{{maxDeals}}': '10',
      '{{upgradeUrl}}': 'https://estetiacrm.com.br/upgrade'
    }
        ...
        <Tabs defaultValue="edit" className="w-full">
          ...
          <TabsContent value="preview" className="space-y-4 mt-4">
            ...
            <div className="border-2 rounded-xl overflow-hidden bg-gradient-to-b from-gray-50 to-white shadow-lg">
              ...
              <div className="bg-gradient-to-r from-[#0a1f3d] to-[#0a1f3d] p-4 text-white">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                    <span className="text-lg font-bold">S</span>
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold">Estetia CRM</p>
                    <p className="text-xs text-white/80">noreply@estetiacrm.com.br</p>
                  </div>
                </div>
              </div>
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-200">
                    <div className="text-center space-y-2">
                      <p className="text-sm text-gray-600 font-semibold">Estetia CRM</p>
                      <p className="text-xs text-gray-500">Gerencie seus negócios de forma inteligente</p>
                      <div className="flex items-center justify-center gap-4 mt-4">
                        <a href="#" className="text-xs text-[#0a1f3d] hover:underline">Dashboard</a>
                        <span className="text-gray-300">•</span>
                        <a href="#" className="text-xs text-[#0a1f3d] hover:underline">Suporte</a>
                        <span className="text-gray-300">•</span>
                        <a href="#" className="text-xs text-[#0a1f3d] hover:underline">Configurações</a>
                      </div>
                    </div>
                  </div>
                </div>
