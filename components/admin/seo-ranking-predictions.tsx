    ...
    <Card className="border-slate-200 bg-white shadow-sm">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="flex items-center gap-2 text-slate-900">
              <BarChart3 className="h-5 w-5 text-[#0a1f3d]" />
              Ranking Predictions (ML)
            </CardTitle>
            <CardDescription className="text-slate-500">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right px-3 py-1.5 rounded-lg bg-[#eef2f9] border border-indigo-200">
              <p className="text-xs text-[#0a1f3d]">Valor Estimado</p>
        ...
        <div className="mt-6 pt-4 border-t border-slate-200">
          <div className="flex items-center justify-between text-xs text-slate-500">
            <div className="flex items-center gap-2">
              <BarChart3 className="h-3 w-3 text-[#0a1f3d]" />
      ...
      <div className={`p-4 ${colors.bg}`}>
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex-1 h-2 bg-white/50 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#1a3560] to-[#1a3560]"
