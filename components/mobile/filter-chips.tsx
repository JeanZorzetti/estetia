    ...
    >
      {chips.map((chip) => (
        <button
          ...
          className={cn(
            ...
            chip.active
              ? 'border border-[#0a1f3d]/30 bg-[#1a3560]/10 text-[#0a1f3d] dark:text-[#489fb5]'
        ...
        >
          ...
          {chip.active && chip.removable && onRemoveChip && (
            <span
              ...
              className="ml-0.5 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[#1a3560]/20"
            >
              <X className="h-2 w-2" />
            </span>
          )}
      ...
      {showFiltersButton && onOpenFilters && (
        ...
        >
          ...
          Filtros
          {activeCount > 0 && (
            <span className="flex h-4 w-4 items-center justify-center rounded-full bg-[#1a3560] text-[10px] font-bold text-white">
              {activeCount}
            </span>
          )}
        </button>
