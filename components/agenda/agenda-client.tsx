...
function groupItems(deals: Deal[], tasks: AgendaTask[]): Group[] {
  ...
  return [
    ...
    { label: 'Esta semana', color: 'text-[#0a1f3d] dark:text-[#489fb5]', dotColor: 'bg-[#1a3560]', items: thisWeek },
  ...
  return (
    ...
    >
      <Link
        ...
        className="flex-1 group flex items-center gap-3 px-3 py-2.5 sm:gap-4 sm:px-4 sm:py-3 rounded-xl border border-[#0a1f3d]/20 bg-[#1a3560]/[0.03] hover:bg-[#1a3560]/[0.07] hover:border-[#0a1f3d]/30 transition-all active:scale-[0.99] duration-150"
      >
        <div className={cn(
          'shrink-0 flex flex-col items-center justify-center w-11 sm:w-14 text-center',
          overdue ? 'text-red-500' : 'text-muted-foreground'
        ...
        <div className="flex-1 min-w-0 flex items-start gap-2">
          <CheckSquare className="h-3.5 w-3.5 mt-0.5 shrink-0 text-[#1a3560]/70" />
          <div className="min-w-0">
            <p className="text-sm font-medium text-foreground truncate group-hover:text-[#0a1f3d] dark:group-hover:text-[#489fb5] transition-colors">
              {task.title}
            </p>
        ...
        <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground group-hover:text-[#1a3560] transition-colors" />
      </Link>
