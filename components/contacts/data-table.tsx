      ...
      <div className="flex items-center gap-3">
        ...
        {selectedCount > 0 && (
          <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-2 duration-200">
            <span className="text-sm font-medium text-zinc-600 dark:text-zinc-400 px-3 py-1.5 rounded-lg bg-[#eef2f9] dark:bg-[#1a3560]/10 border border-indigo-200 dark:border-[#0a1f3d]/20 text-indigo-700 dark:text-[#c5a059]">
              ...
              TableRow: ({ item: _item, ...props }: any) => {
                ...
                return (
                  <tr
                    ...
                    className={cn(
                      'border-b border-black/5 dark:border-white/5 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors group data-[state=selected]:bg-[#eef2f9]/50 dark:data-[state=selected]:bg-[#1a3560]/5',
