    ...
    return [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    ...
                    >
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#1a3560]/20 to-[#1a3560]/20 ring-1 ring-white/10 flex items-center justify-center text-xs font-bold text-[#c5a059] shrink-0">
                            {initials}
                        </div>
                        <span className="font-medium text-zinc-900 dark:text-zinc-100 group-hover/name:text-[#0a1f3d] dark:group-hover/name:text-[#489fb5] transition-colors">
                            {name}
                        </span>
                    </div>
                )
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-[#eef2f9] dark:bg-indigo-950/40 border border-indigo-200/60 dark:border-indigo-800/40">
                        <Kanban className="h-3 w-3 text-[#1a3560] dark:text-[#489fb5] shrink-0" />
                        <span className="text-xs font-medium text-indigo-700 dark:text-[#c5a059] whitespace-nowrap">{stage}</span>
                    </div>
                )
            },
        },
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-gradient-to-br from-violet-500/20 to-[#a8853f]/20 flex items-center justify-center text-[10px] font-bold text-violet-500 dark:text-violet-400 ring-1 ring-violet-200 dark:ring-violet-800/40 shrink-0">
                            {initials}
                        </div>
                ...
                return (
                    ...
                    >
                        <Button
                            size="icon"
                            variant="ghost"
                            className="h-7 w-7 rounded-full text-zinc-400 hover:text-[#1a3560] hover:bg-[#1a3560]/10 transition-all opacity-0 group-hover:opacity-100"
