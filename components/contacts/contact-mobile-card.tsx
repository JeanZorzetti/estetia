  ...
  return (
    ...
    <div
      className={cn(
        ...
        selected
          ? 'border-[#0a1f3d]/50 bg-[#eef2f9]/40 dark:bg-[#1a3560]/5'
    ...
    >
      ...
      <div className="flex items-start gap-3 p-4">
        ...
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#1a3560]/20 to-[#1a3560]/20 text-sm font-bold text-[#0a1f3d] ring-1 ring-white/10 dark:text-[#c5a059]"
        >
          {initials}
        </button>
        ...
        <div
          ...
          onClick={onOpenProfile}
        >
          <h3 className="truncate text-sm font-semibold text-zinc-900 dark:text-zinc-100 hover:text-[#0a1f3d] dark:hover:text-[#489fb5] transition-colors">
            {contact.name}
          </h3>
          {contact.company && (
          ...
          {(contact.activeStageName || contact.assigneeName) && (
            <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
              {contact.activeStageName && (
                <span className="inline-flex items-center gap-1 rounded-full bg-[#1a3560]/10 px-2 py-0.5 text-[10px] font-semibold text-[#0a1f3d] dark:text-[#489fb5]">
        ...
        <div className="space-y-1.5 border-t border-border/40 px-4 py-3 text-xs">
          ...
          {(contact.city || contact.state) && (
            <div className="flex items-center gap-2 text-muted-foreground">
              <MapPin className="h-3.5 w-3.5 shrink-0 text-[#1a3560]" />
              <span>
