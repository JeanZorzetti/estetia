      ...
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            isActive && 'border-solid border-[#0a1f3d]/40 bg-[#1a3560]/5 text-[#0a1f3d] dark:text-[#489fb5]'
          )}
        >
          <Filter className="h-3.5 w-3.5" />
          {label}
          {isActive && (
            <span className="ml-1 rounded-full bg-[#1a3560]/15 px-1.5 py-0.5 text-[10px] font-bold text-[#0a1f3d] dark:text-[#489fb5]">
              {selected.length}
            </span>
          )}
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    checked && 'bg-[#eef2f9]/60 dark:bg-[#1a3560]/5'
                  )}
                >
                  <div
                    className={cn(
                      ...
                      checked
                        ? 'bg-[#0a1f3d] border-indigo-600 text-white'
