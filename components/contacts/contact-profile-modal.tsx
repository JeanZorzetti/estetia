            ...
            <div className="min-w-0 flex-1">
                ...
                {href ? (
                    <a
                        ...
                        className="mt-0.5 block truncate text-sm font-medium text-zinc-800 dark:text-zinc-200 hover:text-[#0a1f3d] dark:hover:text-[#489fb5] transition-colors"
                    >
                        {value}
                    </a>
                ) : (
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden gap-0">
                {/* Hero header */}
                <div className="relative bg-gradient-to-br from-[#0a1f3d] via-violet-600 to-purple-700 px-6 pb-8 pt-6">
