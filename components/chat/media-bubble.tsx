...
// Media bubble (image/video/audio/document) — extracted from message-area.tsx

import { useState, useEffect, useRef, useCallback } from 'react'
import {
  Loader2, Image as ImageIcon, Video, FileText, Download, Play,
} from 'lucide-react'
import { cn } from '@/lib/utils'
import type { WhatsAppMessage } from './chat-types'
import { getMediaTypeFromText, getMediaCaption, isMediaLoaded } from './message-helpers'
