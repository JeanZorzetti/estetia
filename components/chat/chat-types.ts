// Shared types for the chat module (extracted from message-area.tsx)
...
export interface Connection { id: string; instanceName: string; phoneNumber: string | null; displayName?: string | null }
