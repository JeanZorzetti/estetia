...
export function WhatsAppSetupCta({ variant, whatsappUrl, setupPaid }: WhatsAppSetupCtaProps) {
  ...
  const directWhatsappUrl = `https://wa.me/5562998015884?text=${encodeURIComponent('Olá! Tenho interesse na implantação do WhatsApp Oficial pelo Estetia CRM. Vi o guia de configuração e prefiro contratar o serviço — pode me passar os detalhes?')}`
