...
import { Menu, ChevronDown, ChevronRight, Calculator, ArrowRight } from 'lucide-react'
...
const FERRAMENTAS_KEYS = [
    ...
    { href: '/ferramentas/calculadora-no-show' as const, tKey: 'no_show' },
    { href: '/ferramentas/calculadora-ltv' as const, tKey: 'ltv' },
    { href: '/ferramentas/calculadora-precificacao' as const, tKey: 'pricing' },
    { href: '/ferramentas/avaliacao-maturidade-digital' as const, tKey: 'maturity' },
]
