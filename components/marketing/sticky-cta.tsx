      ...
      <div className="mx-4 mb-4 rounded-2xl border border-white/10 bg-zinc-900/95 backdrop-blur-xl shadow-2xl">
        <div className="relative p-4">
          ...
          <div className="pr-6">
            ...
            <Link
              href="/register"
              className="flex items-center justify-center h-11 w-full rounded-lg bg-[#0a1f3d] text-white font-semibold hover:bg-[#1a3560] transition-colors shadow-lg shadow-indigo-500/20"
            >
              Criar Conta Grátis
