...
/**
 * CompetitorMatrix - Estetia vs Competitors Comparison
 *
 * Displays comparison matrix with:
 * - Feature comparison
 * - Pricing comparison
 * - Highlight of Estetia advantages
 */
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>
                Estetia vs {selectedCompetitors.map(c => c.name).join(', ')}
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-0">
          ...
          >
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-medium">Vantagem Estetia:</span>
