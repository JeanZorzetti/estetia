...
describe('ROICalculator', () => {
    ...
    it('should calculate payback period correctly', () => {
        ...
        // Payback = withEstetia / monthlySavings = 8000 / 7000 ≈ 1.1 months
    ...
    it('should allow editing Estetia cost and recalculate', async () => {
        const user = userEvent.setup()
        render(<ROICalculator {...defaultProps} />)

        const siriusCostInput = screen.getByLabelText(/Com Estetia CRM/i) as HTMLInputElement

        // Change Estetia cost to 5000
    ...
    it('should handle negative savings gracefully', async () => {
        ...
        // Set Estetia cost higher than current cost (negative savings)
        await user.clear(siriusCostInput)
